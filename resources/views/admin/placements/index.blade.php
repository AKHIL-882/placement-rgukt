                ...
                <button type="submit" title="Search"><i class="bi bi-search"></i></button>
                        ...
                        <form method="POST" action="{{ route('admin.logout') }}">
                            ...
                            <x-dropdown-link :href="route('admin.logout')"
                               ...
                               <button class=" btn btn-danget " style="float:right"> <i class="fa fa-power-off" aria-hidden="true"></i></button>
                            </x-dropdown-link>
                        </form>
    </header>
        ...
        <section class="section dashboard">
            ...
            <div class="pagetitle mt-5000 container">
                <div class="card p-3" style="height:auto;">
                    <h4>Placement Details <button type="button" class="btn btn-info" style="float:right";><a href="{{url('/admin/placements/create')}}" >Create</a></button></h4>
