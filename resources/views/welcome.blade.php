<!DOCTYPE html> <html lang="en"> <head> <meta charset="utf-8"> <meta content="width=device-width, initial-scale=1.0"
    name="viewport">
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"> <title>| Placements - RGUKT SKLM
    | Dashboard </title> <meta content="" name="description"> <meta content="" name="keywords">

<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">

<link href="logo.jfif" rel="icon"> <link href="logo.jfif" rel="apple-touch-icon"> <link rel="stylesheet"
...
<link
    ...
    rel="stylesheet"> <link href="/css/bootstrap.min.css" rel="stylesheet"> <script src="css/app.js"
    type="text/javascript"></script> <link href="/css/style.css" rel="stylesheet">

</head> <body> <header id="header" class="header fixed-top d-flex align-items-center">
...
</header> <!-- <aside id="sidebar" class="sidebar"> <ul class="sidebar-nav" id="sidebar-nav">
<li class="nav-item">
...
<!-- <div class="pagetitle mt-5000 container">
        ...
        <div class="ticker container">
            <div class="title">
                <h5 style="color: white";>Breaking News</h5>
            </div>
            <div class="news">
    ...
    <div class="card p-3" style="height:auto;">
        ...
        <div class="table-responsive">
            <table id="dtHorizontalExample"
                class="table table-striped table-hover mt-4 table-bordered table-sm  text-center" cellspacing="0"
                width="100%">
                <thead>
                    <tr>
                        <th></th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <i class="fa fa-eye" aria-hidden="true" class="view-button"
                                data-placement-id="{{ $placement->id }}"></i> <span class="view-count">0</span>
                        </td>
                        <td>{{ $placement->company_name }}</td>
                        <td>{{ $placement->type }}</td>
                        <td>{{ $placement->branch }}</td>
...
<footer id="footer" class="footer">
    <div class="copyright">
        <strong><span>
                <div class="credits">
                    &copy; Designed and Developed by <a href="https://www.linkedin.com/in/duggirala-akhil-151768187/"
                        target="_blank">| Akhil Duggirala |</a>
                </div>
            </span></strong> All Rights Reserved
        <img src="https://hitwebcounter.com/counter/counter.php?page=8022360&style=0025&nbdigits=5&type=page&initCount=0"
            title="Free Counter" Alt="web counter" border="0" style="float:right; height:18px" />
    </div>
</footer>
